...
lib.callback.register("cfx_requestsearch:sendRequest", function(source, target)
  lib.callback.await("cfx_requestsearch:receiveRequest", target, source, target)
end)

lib.callback.register("cfx_requestsearch:acceptRequest", function(source, target)
